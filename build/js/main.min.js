...
var _jurySwiper = require("./modules/jury-swiper");
var _juryClick = require("./modules/jury-click");
var _reviewsSwiper = require("./modules/reviews-swiper");
var _subscriptions = require("./modules/subscriptions");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    (0, _video.videoPlay)();
    (0, _subscriptions.subscriptionCard)();
    (0, _jurySwiper.initSwiper)();
    (0, _juryClick.slideClick)();
    (0, _juryClick.removeClass)();
    (0, _initAccordion.initAccordions)();
    (0, _initTabs.initTabs)();
    (0, _reviewsSwiper.initSwiperReviews)();
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/jury-click":11,"./modules/jury-swiper":12,"./modules/modals/init-modals":13,"./modules/reviews-swiper":15,"./modules/subscriptions":16,"./modules/tabs/init-tabs":17,"./modules/video":19,"./utils/ios-vh-fix":22}],2:[function(require,module,exports){
"use strict";
...
exports.slideClick = exports.removeClass = void 0;
var slidesList = document.querySelectorAll('[data-jury="jury-item"]');
var slideClick = exports.slideClick = function slideClick() {
  slidesList.forEach(function (item) {
    item.addEventListener('click', function () {
      slidesList.forEach(function (el) {
...
var removeClass = exports.removeClass = function removeClass() {
  window.addEventListener('click', function (e) {
    var checkedSlide = document.querySelector('.slide-active');
    var target = e.target;
...
var initSwiper = exports.initSwiper = function initSwiper() {
  var buttonNext = document.querySelector('[data-button="jury-button-prev"]');
  var buttonPrev = document.querySelector('[data-button="jury-button-next"]');
  var slides = document.querySelectorAll('[data-jury="jury-item"]');
  var slidesArr = _toConsumableArray(slides);
  var swiper = new window.Swiper('[data-jury="jury-slider"]', {
    loop: true,
    navigation: {
      nextEl: buttonNext,
      prevEl: buttonPrev
...
var initSwiperReviews = exports.initSwiperReviews = function initSwiperReviews() {
  var reviewsbuttonPrev = document.querySelector('[data-button="reviews-button-prev"]');
  var reviewsbuttonNext = document.querySelector('[data-button="reviews-button-next"]');
  var slides = document.querySelectorAll('.reviews__item');
  var slidesArr = _toConsumableArray(slides);
  var swiper = new window.Swiper('[data-reviews="reviews-slider"]', {
    loop: false,
    navigation: {
...
var SubscriptionButton1 = document.querySelector('[data-subscription="subscription-button-1"]');
var SubscriptionButton6 = document.querySelector('[data-subscription="subscription-button-6"]');
var SubscriptionButton12 = document.querySelector('[data-subscription="subscription-button-12"]');
var SubscriptionList = document.querySelector('[data-subscription="subscription-list"]');
var PriceTrainer = document.querySelector('[data-price="trainer"]');
var PriceDay = document.querySelector('[data-price="day"]');
var PriceFullDay = document.querySelector('[data-price="full"]');
var subscriptionCard = exports.subscriptionCard = function subscriptionCard() {
  SubscriptionButton1.addEventListener('click', function () {
  ...
  SubscriptionButton6.addEventListener('click', function () {
  ...
  SubscriptionButton12.addEventListener('click', function () {
    SubscriptionList.classList.remove('subscription__list--six');
...
var PlayButton = document.querySelector('[data-video="video-button"]');
var Iframe = document.getElementById('video');
var videoPlay = exports.videoPlay = function videoPlay() {
